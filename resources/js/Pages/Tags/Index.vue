            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <section class="container mx-auto p-6 font-mono">
                    <div class="w-full flex mb-4 p-2 justify-end">
                        <Link :href="route('admin.tags.create')" class="px-4 py-2 bg-green-600 hover:bg-green-800 text-white rounded-lg">Create Tag</Link>
                    </div>
                            ...
                            <table class="w-full">
                                ...
                                <tr v-for="tag in tags.data" :key="tag.id" class="text-gray-700">
                                    ...
                                    <td class="flex justify-around px-4 py-3 text-sm border">
                                        <Link :href="route('admin.tags.edit', tag.id)" class="bg-green-500 hover:bg-green-700 text-white px-4 py-2 mx-3 rounded-lg">Edit</Link>
                                        <Link :href="route('admin.tags.destroy', tag.id)" method="delete" as="button" type="button" class="bg-red-500 hover:bg-red-700 text-white px-4 py-2 rounded-lg">Delete</Link>
                                    </td>
                                </tr>
...
watch(search, value => {
    Inertia.get('/admin/tags', { search: value }, {preserveState: true, replace:true})
});
