                ...
                <section class="container mx-auto p-6 font-mono">
                    <div class="w-full flex mb-4 p-2 justify-end">
                        <form class="flex space-x-4 shadow bg-white rounded-md m-2 p-2">
                            <div class="p-1">
                                <button type="button" @click="generateGenres"
                                    ...
                                    <svg v-if="showSpinner" class="animate-spin -ml-1 mr-3 h-5 w-5 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                    ...
                    <div class="w-full overflow-x-auto">
                            ...
                            <TableRow v-for="genre in genres.data" :key="genre.id">
                                ...
                                <TableData>
                                    ...
                                    <div class="flex justify-around">
                                        ...
                                        <ButtonLink method="delete" as="button" type="button" class="bg-red-500 hover:bg-red-700" :link="route('admin.genres.destroy', genre.id)">Delete</ButtonLink>
                        ...
                        <div class="bg-white my-1 py-1" v-if="genres.data.length">
...
watch(search, value => {
    Inertia.get('/admin/genres', { search: value }, {preserveState: true, replace:true})
});
