                            ...
                            <TableRow v-for="cast in casts.data" :key="cast.id">
                                ...
                                <TableData>
                                    ...
                                    <div class="flex justify-around">
                                        ...
                                        <ButtonLink method="delete" as="button" type="button" class="bg-red-500 hover:bg-red-700" :link="route('admin.casts.destroy', cast.id)">Delete</ButtonLink>
...
watch(search, value => {
    Inertia.get('/admin/casts', { search: value }, {preserveState: true, replace:true})
});

function generateCast(){
    Inertia.post('/admin/casts', {castTMDBId: castTMDBId.value}, {
        onFinish: () => (castIMDBId.value = "")
    });
