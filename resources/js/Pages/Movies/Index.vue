                    ...
                    <div class="w-full flex mb-4 p-2 justify-end">
                        <form class="flex space-x-4 shadow bg-white rounded-md m-2 p-2">
                            <div class="p-1 flex items-center">
                                <label for="tmdb_id_g" class="block text-sm font-medium text-gray-700 mr-4">MovieTmdb Id</label>
                            ...
                            <div class="p-1">
                                <button type="button" @click="generateMovie"
                    ...
                    <div class="w-full overflow-x-auto">
                        ...
                        <Table>
                            ...
                            <TableRow v-for="movie in movies.data" :key="movie.id">
                                ...
                                <TableData>   <span v-if="movie.is_public" class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800">
                                        Published
                                    </span>
                                ...
                                <TableData>
                                    ...
                                    <div class="flex space-x-2">
                                        <ButtonLink class="bg-blue-500 hover:bg-blue-700" :link="route('admin.movies.attach', movie.id)">Attach</ButtonLink>
                                        <ButtonLink :link="route('admin.movies.edit', movie.id)">Edit</ButtonLink>
                                        <ButtonLink method="delete" as="button" type="button" class="bg-red-500 hover:bg-red-700" :link="route('admin.movies.destroy', movie.id)">Delete</ButtonLink>
